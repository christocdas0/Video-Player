var playlistData = [
  {
    ...
    thumbnail: "https://i.ytimg.com/vi/jbeQfFozOQs/maxresdefault.jpg",
  },
  {
    id: "2",
    title: "Perfect Mashed Potatoes and Gravy",
    thumbnail: "https://i.ytimg.com/vi/zO5qtrG_ln4/maxresdefault.jpg",
  },
  {
    id: "3",
    title: "The Heart of Soba",
    thumbnail:
      "https://images.squarespace-cdn.com/content/v1/57428d4a4d088e1eb6214d09/1552070905792-I6IZG898LWOSGRQUVO5N/The+Heart+of+Soba_Film_Andrew+Gooi_Filmmaker_Brand+Storyteller115.jpg?format=1000w",
  },
  {
    id: "4",
    title: "Grilled Cheese 9 Ways",
    thumbnail:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiuCr2C7vNqDgjmcHR3202apCgsCmYngl13w&usqp=CAU",
  },
  {
    id: "5",
    title: "Pineapple Cheesecake",
    thumbnail:
      "https://static.toiimg.com/thumb/61153731.cms?imgsize=307830&width=800&height=800",
  },
  {
    id: "6",
    title: "Lemony Chicken Noodle Soup",
    thumbnail:
      "https://feelgoodfoodie.net/wp-content/uploads/2019/01/Chicken-Lemon-Rice-Soup-8-640x960.jpg",
  },
  {
    id: "7",
    title: "Pumpkin Roll",
    thumbnail: "https://i.ytimg.com/vi/bUTGDt3eh7Q/maxresdefault.jpg",
  },
  {
    id: "8",
    title: "How to Brine a Turkey",
    thumbnail:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2EkwOyxgyjDDgvMcMqtLXyEwIHnBQ7GVobw&usqp=CAU",
  },
  {
    id: "9",
    title: "Stop Motion Dry-Brined Turkey Recipe",
    thumbnail: "https://i.ytimg.com/vi/dU61dsfGsuI/maxresdefault.jpg",
  },
  {
    id: "10",
    title: "Butternut Squash Ravioli",
    thumbnail:
      "https://food-images.files.bbci.co.uk/food/recipes/butternut_squash_ravioli_31141_16x9.jpg",
  },
];
...
playlistData.map((playList) => {
  playListWrapper.innerHTML += `
        ...
        <div id="card${playList.id - 1}" class="playlist-card ${
    playList.id - 1 == 0 ? "active-card" : ""
  }" onclick =' borderChange(card${playList.id - 1})' >
              <img
                class="thumbnail"
                src=${playList.thumbnail}
              />
              <h3 class="video-card-title">${playList.title}</h3>
            </div>
     `;
});

function borderChange(playlist) {
  $(".playlist-card").removeClass("active-card");
  var curentActiveCard = document.getElementById(playlist.id);
  curentActiveCard.classList.add("active-card");

  var videoCardsId = curentActiveCard.id;
  videoCardsId = videoCardsId.charAt(videoCardsId.length - 1);

  var mainVideodatas = videoPlaySectionData[videoCardsId];

  mainVideoPlayer(mainVideodatas);
}

function mainVideoPlayer(data) {
  // video player wrapper
  var videoPLayerWrapper = document.getElementById("player-wrapper");
